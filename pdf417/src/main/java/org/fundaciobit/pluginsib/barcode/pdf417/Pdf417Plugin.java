package org.fundaciobit.pluginsib.barcode.pdf417;
...
public class Pdf417Plugin implements IBarcodePlugin {
    ...
    public Image generateTextBarCode(String text) throws Exception {
         ...
         * 
         * if (height2 != null) { BufferedImage scaled =
         * ImageUtils.getScaledImageHeight(buff, height2); return scaled; } else {
         * return buff; }
         */
        // ITEXT
        BarcodePDF417 pdf417 = new BarcodePDF417();
    ...
    @Override
    public com.itextpdf.text.Image generateUserInfoBarCodeIText(UserInfo userInfo) throws Exception {
        return null;
    }
